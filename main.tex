...
% The title of the proposal is non-binding w.r.t. the dissertation title.
...
% break inside a TikZ node. \systemsingular names one such structure, as a
% common noun, which the project name capitalizes.
\NewDocumentCommand{\system}{O{\textit}}{#1{Smart E-Graphs}}
\NewDocumentCommand{\systemsingular}{O{\textit}}{#1{smart e-graph}}
