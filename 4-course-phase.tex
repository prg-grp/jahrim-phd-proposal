...
Second, I developed \textit{versioned e-graphs}, which extend e-graphs to
...
the state of the art~\cite{singher2024easteregg}, where versioned e-graphs used up to $30\%$ less memory and
ran up to $4\times$ faster, with the gap widening as the number of explored
terms and branches grew.